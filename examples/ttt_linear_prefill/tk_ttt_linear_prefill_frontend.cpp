...
extern void  ttt_linear_prefill_fp32(torch::Tensor W1, torch::Tensor b1,
                                     torch::Tensor ln_weight, torch::Tensor ln_bias,
                                     torch::Tensor cumsum_matrix, torch::Tensor make_last_b_matrix,
                                     torch::Tensor make_last_eta_1_matrix,
                                     torch::Tensor XV, torch::Tensor XK, torch::Tensor XQ, torch::Tensor Eta,
...
extern void  ttt_linear_prefill_fp32_ref(torch::Tensor W1, torch::Tensor b1,
                                         torch::Tensor ln_weight, torch::Tensor ln_bias,
                                         torch::Tensor cumsum_matrix, torch::Tensor make_last_b_matrix,
                                         torch::Tensor make_last_eta_1_matrix,
                                         torch::Tensor XV, torch::Tensor XK, torch::Tensor XQ, torch::Tensor Eta,
...
{
    auto stream = at::cuda::getCurrentCUDAStream();
    ttt_linear_prefill_fp32(W1, b1, ln_weight, ln_bias,
                            cumsum_matrix, make_last_b_matrix,
                            make_last_eta_1_matrix,
                            XV, XK, XQ, Eta, Out, stream);
}

extern void  ttt_linear_prefill_no_cumsum_matrix_fp16(torch::Tensor W1, torch::Tensor b1,
                                     torch::Tensor ln_weight, torch::Tensor ln_bias,
...
extern void  ttt_linear_prefill_no_cumsum_matrix_fp16_ref(torch::Tensor W1, torch::Tensor b1,
                                         torch::Tensor ln_weight, torch::Tensor ln_bias,
                                         torch::Tensor make_last_b_matrix,
                                         torch::Tensor make_last_eta_1_matrix,
                                         torch::Tensor XV, torch::Tensor XK, torch::Tensor XQ, torch::Tensor Eta,
...
{
    auto stream = at::cuda::getCurrentCUDAStream();
    ttt_linear_prefill_no_cumsum_matrix_fp16(W1, b1, ln_weight, ln_bias,
                                             make_last_b_matrix,
                                             make_last_eta_1_matrix,
                                             XV, XK, XQ, Eta, Out, stream);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("ttt_linear_prefill_no_cumsum_matrix_fp16", &ttt_linear_prefill_no_cumsum_matrix_fp16_ref);
    m.def("ttt_linear_prefill_fp32", &ttt_linear_prefill_fp32_ref);
}