...
extern void  prefill_whole_loop_LN_bias_res_PLN_fp16(torch::Tensor W1, torch::Tensor b1,
                                                     torch::Tensor ln_weight, torch::Tensor ln_bias,
                                                     torch::Tensor cumsum_matrix, torch::Tensor make_last_b_matrix,
                                                     torch::Tensor make_last_coeff_1_matrix,
                                                     torch::Tensor XA, torch::Tensor XB, torch::Tensor XC, torch::Tensor Coeff,
...
extern void  prefill_whole_loop_LN_bias_res_PLN_fp16_ref(torch::Tensor W1, torch::Tensor b1,
                                                         torch::Tensor ln_weight, torch::Tensor ln_bias,
                                                         torch::Tensor cumsum_matrix, torch::Tensor make_last_b_matrix,
                                                         torch::Tensor make_last_coeff_1_matrix,
                                                         torch::Tensor XA, torch::Tensor XB, torch::Tensor XC, torch::Tensor Coeff,
...
{
    auto stream = at::cuda::getCurrentCUDAStream();
    prefill_whole_loop_LN_bias_res_PLN_fp16(W1, b1, ln_weight, ln_bias,
                                            cumsum_matrix, make_last_b_matrix,
                                            make_last_coeff_1_matrix,
                                            XA, XB, XC, Coeff, Out, stream);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("prefill_whole_loop_LN_bias_res_PLN_fp16", &prefill_whole_loop_LN_bias_res_PLN_fp16_ref);
}