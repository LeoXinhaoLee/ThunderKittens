...
/*** FP16 gelu coeff bias LN + residual + post LN Kernel ***/
template <typename H, typename T>
__global__
void prefill_whole_loop_gelu_coeff_bias_LN_res_PLN_ker_fp16(
        const int NH, const int NC, const int CS, const int HF, const int HF_prime,
        T* __W1, T* __W2,
        T* __b1, T* __b2,
        const T* __ln_weight, const T* __ln_bias,
...
void
prefill_whole_loop_gelu_coeff_bias_LN_res_PLN_fp16
        (
                torch::Tensor W1,
                torch::Tensor W2,
                torch::Tensor b1,
    ...
    prefill_whole_loop_gelu_coeff_bias_LN_res_PLN_ker_fp16<H, T><<<batch * head, threads, SMEM_BLOCK, stream>>>(
            head, NC, CS, HF, HF_prime,
            W1.data_ptr<T>(), W2.data_ptr<T>(),
            b1.data_ptr<T>(), b2.data_ptr<T>(),
            ln_weight.data_ptr<T>(), ln_bias.data_ptr<T>(),
...
/*** FP16 coeff bias LN + residual + post LN Kernel ***/
template <typename H, typename T>
__global__
void prefill_whole_loop_coeff_bias_LN_res_PLN_ker_fp16(
        const int NH, const int NC, const int CS, const int HF, const int HF_prime,
        T* __W1, T* __W2,
        T* __b1, T* __b2,
        const T* __ln_weight, const T* __ln_bias,
...
void
prefill_whole_loop_coeff_bias_LN_res_PLN_fp16
        (
                torch::Tensor W1,
                torch::Tensor W2,
                torch::Tensor b1,
    ...
    prefill_whole_loop_coeff_bias_LN_res_PLN_ker_fp16<H, T><<<batch * head, threads, SMEM_BLOCK, stream>>>(
            head, NC, CS, HF, HF_prime,
            W1.data_ptr<T>(), W2.data_ptr<T>(),
            b1.data_ptr<T>(), b2.data_ptr<T>(),
            ln_weight.data_ptr<T>(), ln_bias.data_ptr<T>(),
...
/*** FP16 coeff bias LN Kernel ***/
template <typename H, typename T>
__global__
void prefill_whole_loop_coeff_bias_LN_ker_fp16(
        const int NH, const int NC, const int CS, const int HF, const int HF_prime,
        T* __W1, T* __W2,
        T* __b1, T* __b2,
        const T* __ln_weight, const T* __ln_bias,
...
void
prefill_whole_loop_coeff_bias_LN_fp16
        (
                torch::Tensor W1,
                torch::Tensor W2,
                torch::Tensor b1,
    ...
    prefill_whole_loop_coeff_bias_LN_ker_fp16<H, T><<<batch * head, threads, SMEM_BLOCK, stream>>>(
            head, NC, CS, HF, HF_prime,
            W1.data_ptr<T>(), W2.data_ptr<T>(),
            b1.data_ptr<T>(), b2.data_ptr<T>(),
            ln_weight.data_ptr<T>(), ln_bias.data_ptr<T>(),
