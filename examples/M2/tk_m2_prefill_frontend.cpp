...
extern void  prefill_whole_loop_coeff_bias_LN_res_PLN_fp16(torch::Tensor W1,
                                                           torch::Tensor W2,
                                                           torch::Tensor b1,
                                                           torch::Tensor b2,
                                                           torch::Tensor ln_weight,
...
extern void  prefill_whole_loop_coeff_bias_LN_res_PLN_fp16_ref(torch::Tensor W1,
                                                               torch::Tensor W2,
                                                               torch::Tensor b1,
                                                               torch::Tensor b2,
                                                               torch::Tensor ln_weight,
                                                               ...
                                                               torch::Tensor Output) {
    auto stream = at::cuda::getCurrentCUDAStream();
    prefill_whole_loop_coeff_bias_LN_res_PLN_fp16(W1,
                                                  W2,
                                                  b1,
                                                  b2,
                                                  ln_weight,
...
extern void  prefill_whole_loop_coeff_bias_LN_fp16(torch::Tensor W1,
                                                           torch::Tensor W2,
                                                           torch::Tensor b1,
                                                           torch::Tensor b2,
                                                           torch::Tensor ln_weight,
...
extern void  prefill_whole_loop_coeff_bias_LN_fp16_ref(torch::Tensor W1,
                                                               torch::Tensor W2,
                                                               torch::Tensor b1,
                                                               torch::Tensor b2,
                                                               torch::Tensor ln_weight,
                                                               ...
                                                               torch::Tensor Output) {
    auto stream = at::cuda::getCurrentCUDAStream();
    prefill_whole_loop_coeff_bias_LN_fp16(W1,
                                                  W2,
                                                  b1,
                                                  b2,
                                                  ln_weight,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("prefill_whole_loop_coeff_bias_LN_res_PLN_fp16", prefill_whole_loop_coeff_bias_LN_res_PLN_fp16_ref);
    m.def("prefill_whole_loop_coeff_bias_LN_fp16", prefill_whole_loop_coeff_bias_LN_fp16_ref);
}